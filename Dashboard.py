...
def openimg():
	...
	image = cv2.imread('SIBI.png')
	cv2.imshow("Image",image)
	cv2.setWindowProperty("Image",cv2.WND_PROP_FULLSCREEN,cv2.WINDOW_FULLSCREEN)
	cv2.resizeWindow("Image",298,430)
	cv2.moveWindow("Image", 1400,214)
...
class Dashboard(QtWidgets.QMainWindow):
	def __init__(self):
		...
		movie = QtGui.QMovie("icons/Sibi.gif")
		self.label_3.setMovie(movie)
		self.label_3.setGeometry(160,160,780,441)
		movie.start()
	...
	def createGest(self):
		...
		while True:
			...
			try:
				...
				img2 = cv2.rectangle(frame, (150,50),(570,210), (0,255,0), thickness=2, lineType=8, shift=0)
			except:
	...
	def scanSent(self):
		...
		while True:
			...
			try:
				...
				frame = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
				img = cv2.rectangle(frame, (150,50),(570,210), (0,255,0), thickness=2, lineType=8, shift=0)
			except:
				keyboard.press_and_release('esc')
				keyboard.press_and_release('esc')
	...
	def scanSingle(self):
		...
		while True:
			...
			try:
				frame=cv2.resize(frame,(321,270))
				frame = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
				img1 = cv2.rectangle(frame, (150,50),(570,210), (0,255,0), thickness=2, lineType=8, shift=0)
			except:
				keyboard.press_and_release('esc')
			...
			cv2.imshow("mask", mask)
			cv2.setWindowProperty("mask",cv2.WND_PROP_FULLSCREEN,cv2.WINDOW_FULLSCREEN)
			cv2.resizeWindow("mask",125,115)
			cv2.moveWindow("mask", 1150,395)
